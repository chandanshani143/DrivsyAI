...
export async function getCars({
  ...
  try {
    ...
    // Calculate pagination - how many records to skip
    const skip = (page - 1) * limit;     //up we have set limit = 6 & page = 1 by default
    ...
    const serializedCars = cars.map((car) =>
      serializeCarData(car, wishlisted.has(car.id))  //calling helper function from lib/helpers
    );
