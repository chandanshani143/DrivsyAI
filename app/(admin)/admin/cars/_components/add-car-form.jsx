...
const AddCarForm = () => {
  ...
  // Handling successful AI processing
  useEffect (() => {
  ...
  const onMultipleImageDrop = useCallback((acceptedFiles) => {
  ...
  const onSubmit = async (data) => {
    ...
    // Taking all data from the form and formatting some data for server action
    const carData = {
      ...data,
    ...
    // Call the addCar function with our useFetch hook with the form data and images
    await addCarFn({
      carData,
              ...
              <div className="space-y-6">
                ...
                {processImageLoading && (
                  <div className="bg-blue-50 text-blue-700 p-4 rounded-md flex items-center">
                    <Loader2 className="animate-spin h-5 2-5 mr-2"/>
