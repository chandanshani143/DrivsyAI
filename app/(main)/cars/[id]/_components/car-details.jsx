...
export function CarDetails({ car, testDriveInfo }) {
  ...
  const [currentImageIndex, setCurrentImageIndex] = useState(0); // Track current image index for carousel
  ...
  // Handle save car action for wishlist
  ...
  // Handle share for copying link or using Web Share API
  const handleShare = () => {
    if (navigator.share) {
      navigator
        .share({
          title: `${car.year} ${car.make} ${car.model}`,
          text: `Check out this ${car.year} ${car.make} ${car.model} on DrivsyAI!`,
    ...
    <div>
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-7/12">
          ...
          {/* Secondary Actions -> Save and Share */}
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>DrivsyAI Car Loan Calculator</DialogTitle>
          ...
          {/* Warning if car is sold or unavailable */}
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">DrivsyAI Motors</h4>
